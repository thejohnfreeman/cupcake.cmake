...
macro(cupcake_project)
  ...
  set(dependencies ${PROJECT_NAME}_dependencies)
  add_library(${dependencies} INTERFACE)
  install(TARGETS ${dependencies} EXPORT ${PROJECT_EXPORT_SET})
  add_library(${PROJECT_NAME}::dependencies ALIAS ${dependencies})
endmacro()
